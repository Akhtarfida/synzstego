...
@section('content')
    ...
    <?php
    function make_slide_indicators($images){
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride ="carousel" data-interval="false">
                                        <ol class="carousel-indicators">
                                            <?php echo make_slide_indicators($images) ?>
                                        </ol>
                                        <div class="carousel-inner">
                                            <?php   echo make_slides($images) ?>
                                    ...
                                    <tr class="text-dark font-weight-bold">
                                        ...
                                        <td> <img class="admin-photo-thumbnail" src="{{asset($d->name)}}" alt="" width="150px" height="120px">
                                            <div class="action_links">
                                                ...
                                                @if($d->isData==1)
                                                <a class="download_link" href="{{route('stegimg.edit', $d->id)}}">Edit</a>
                                                @endif
                                            </div>
                                        ...
                                        <td><a href="{{ route('image.trash', $d->id) }}" class = "btn btn-secondary">Trash</a></td>
